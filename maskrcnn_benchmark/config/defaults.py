...
# COLOR TRANSFORMS
_C.INPUT.CONTRAST_NORMALIZATION_RANGE = 1.0  # (0.6, 1.4)
_C.INPUT.LINEAR_CONTRAST_RANGE = 1.0  # (0.9, 1.1)
_C.INPUT.BRIGHTNESS_RANGE = 1.0  # (0.7, 1.3)
_C.INPUT.HUE_SAT_ADD_RANGE = 0.0  # (-30, 30)

# GEOMETRIC TRANSFORMS
_C.INPUT.FLIPLR_PROB = 0.5
_C.INPUT.CROP_MAX = 0.0  # 0.35
_C.INPUT.ZOOM_RANGE = 1.0  # (0.8, 1.2)
_C.INPUT.TRANSLATION_RANGE = 0.0  # (-0.3, 0.3)
_C.INPUT.ROTATE_DEGREES_RANGE = 0.0  # (-75, 75)
_C.INPUT.SHEAR_RANGE = 0.0  # (-10, 10)
